Route::namespace('Frontend')->middleware(['siteisclosed'])->group(function () {
    ...
    Route::get('/event/refresh', [
        'uses' => 'TestController@sportsRefresh'
    ]);
    Route::get('/soccer/odd/refresh', [
        'uses' => 'TestController@soccerOddsRefresh'
    ]);
    ...
    */
      ...
      /**
     * Start Bets API Route 
     */

    Route::get('/games/sports', [
        'as' => 'frontend.game.sports.list',
        'uses' => 'GamesController@apiSports'
    ]);
    Route::get('/games/inplay/{sport}', [
        'as' => 'frontend.game.inplay.event',
        'uses' => 'GamesController@inplayEvents'
    ]);
    Route::get('/games/inplay/{sport}/event/{eventID}', [
        'as' => 'frontend.game.inplay.event.get',
        'uses' => 'GamesController@getInplayEvent'
    ]);
    Route::get('/featured/games/{sport}', [
        'as' => 'frontend.featured.game.event',
        'uses' => 'GamesController@featuredGames'
    ]);
    Route::get('/prematch/odds/{eventID}', [
        'as' => 'frontend.event.prematch.odds',
        'uses' => 'GamesController@prematchOdds'
    ]);
